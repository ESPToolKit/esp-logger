...
class JsonVariantConst {
  public:
    ...
    JsonVariantConst(const char* value) : _compact(detail::quote(value != nullptr ? value : "")), _pretty(_compact) {}
    ...
    const std::string& compact() const { return _compact; }
...
template <>
inline JsonVariantConst JsonDocument::as<JsonVariantConst>() const {
    return toVariant();
}
