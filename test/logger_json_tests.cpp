...
void test_json_document_logs_compact_when_disabled() {
    ...
    expect_equal(logs.front().message, std::string("{\"hello\":\"world\",\"answer\":7}"),
...
void test_json_document_logs_pretty_by_default() {
    ...
    expect_equal(logs.front().message, std::string("{\n  \"hello\": \"world\"\n}"),
...
void test_live_callback_receives_json_message() {
    ...
    expect_equal(liveLogs.front().message, std::string("{\"hello\":\"world\"}"),
...
void test_sync_callback_receives_json_message() {
    ...
    expect_equal(syncedLogs.size(), static_cast<size_t>(1), "Sync callback should receive JSON log");
    expect_equal(syncedLogs.front().message, std::string("{\"hello\":\"world\"}"),
...
void test_printf_logging_still_works_in_json_build() {
    ...
    expect_equal(logs.front().message, std::string("value 5"), "Formatted logging should remain unchanged");
